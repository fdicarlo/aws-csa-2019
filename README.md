...
#### The purpose of this guide is to share my notes taken while studying for the AWS CSA certification exam. I use the awesome ACloud.guru course & other material listed below which I feel will help certification aspirants for purpose of self-study and quick revision. The course content copyrights are owned by [ACloud Guru Ltd.](https://acloud.guru)
...
### [AWS 10000 Feet Overview](./AWS_overview.md)
### [IAM - Identity Access Mangement](./IAM.md)
### [AWS Object Storage & CDN – S3, Glacier and CloudFront](./AWS_Object_Storage.md)
### [# EC2 – The Backbone of AWS](./EC2.md)
