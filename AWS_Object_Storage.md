...
### Basics 
  ...
  * S3 is a universal namespace, this is name must be unique globally
  		* Bucket handle => https://s3-eu-west-1.amazonaws.com/acloudguru
  		* [region].amazonaws.com[your-handle]
  * When you upload a file to S3 you will receive a HTTP 200 code if the upload was successful
  * Built for 99.99% availability for the S3 platform
  * Amazon Guarantee 99.99% availability (SLA - Service Level Agreement)
...
### S3 Object Fundamentals
  * S3 is Object based. Objects consist of the following:
  	* Key (This is simply the name of the object) 
  		...
  		* If you have similar file names like with log data you can add a random letter or number at the begining of the file name in order to more evenly distribut where the files are being stored so you don't get bottlenecks 
  		* ^ a good practice for design considerations
  	* Value (The data, and is made up of a sequence of bytes)
  	* Version ID (import and versioning)
  	* MetaData (data aboue the data you're storing, ie timestamp, etc) 
  	* Subresources 
...
### Object Storage Classes
  ...
  * S3 - RRS (Reduced Redundancy Storage) 
  	* Durability - 99.99% 
  	* Availability - 99.99% 
  	* Use when its not a big deal if the data is lost as it can be easily be re-created.
  	* Ex: Thumbnail photos of larger images which can be recreated
  	* 

![S3 Classes](S3-Classes.png)
  
  * Glacier
  	* Very cheap
  	* For archival only 
  	* Takes 3 - 5 hours to restore files. 
  	* Durability - 99.999999999%

![S3 Classes](S3-Classes-II.png)
...
### S3 Charges
  ...
  * Transfer Acceleration
  	* Fast, secure transfers of files over long distances btw your users and an S3 bucket
